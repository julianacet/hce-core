  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div className="card-hce p-5 space-y-4">
        <h3 className="text-sm font-semibold" style={{ color: 'var(--hce-text)' }}>Datos del proveedor</h3>
      ...
      {/* Contacto */}
      <div className="card-hce p-5 space-y-4">
        <h3 className="text-sm font-semibold" style={{ color: 'var(--hce-text)' }}>Contacto</h3>
        <div className="grid grid-cols-2 gap-4">
          <div>
      ...
      {/* Info adicional */}
      <div className="card-hce p-5 space-y-4">
        <h3 className="text-sm font-semibold" style={{ color: 'var(--hce-text)' }}>Información adicional</h3>
        <div>
      ...
      <div className="flex justify-end gap-2">
        ...
        <button type="submit" disabled={guardando} className="btn-hce px-6">
    ...
    <div className="space-y-4">
      <div className="flex items-start justify-between">
        <div>
          ...
          <h3 className="text-base font-semibold" style={{ color: 'var(--hce-text)' }}>
      ...
      <div className="flex gap-2 pt-1 border-t" style={{ borderColor: 'var(--hce-border)' }}>
        <button onClick={onEditar} className="btn-hce flex items-center gap-2 px-4 text-sm">
    ...
    <div className="p-6 max-w-6xl mx-auto space-y-5">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <Building2 className="w-6 h-6" style={{ color: 'var(--hce-primary)' }} />
        ...
        <button onClick={() => { setVista('nuevo'); setSeleccionado(null); setError('') }}
          className="btn-hce flex items-center gap-2 px-4">
