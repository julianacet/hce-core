...
export default function OrdenExamenPDF({
  ...
  const s = StyleSheet.create({
    ...
    seccionTitulo: { fontSize: 7, fontFamily: 'Helvetica-Bold', color: '#94a3b8', textTransform: 'uppercase', letterSpacing: 0.5, marginBottom: 8 },
    ...
    itemIndicaciones: { fontSize: 9, color: '#64748b', fontStyle: 'italic' },

    indicacionesBox: {
      marginTop: 16, padding: 8,
      borderWidth: 0.5, borderColor: '#e2e8f0', borderRadius: 4,
    },
    indicacionesLabel: { fontSize: 7, fontFamily: 'Helvetica-Bold', color: '#94a3b8', textTransform: 'uppercase', letterSpacing: 0.5, marginBottom: 4 },
    indicacionesTexto: { fontSize: 9, color: '#334155', lineHeight: 1.4 },
    ...
    footerTexto: { fontSize: 7, color: '#94a3b8' },
  })
