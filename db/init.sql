...
CREATE TABLE usuario (
    ...
    rol             VARCHAR(20) NOT NULL DEFAULT 'medico'
                                CHECK (rol IN ('admin', 'medico', 'recepcionista', 'enfermeria', 'facturador', 'farmacia')),
...
('personal','¿Tiene asma?','booleano',NULL,TRUE,NULL,NULL,4),
('personal','¿Tiene EPOC u otra enfermedad pulmonar crónica?','booleano',NULL,TRUE,NULL,NULL,5),
...
('personal','¿Tiene insuficiencia cardíaca?','booleano',NULL,TRUE,NULL,NULL,8),
...
('personal','¿Tiene epilepsia o convulsiones?','booleano',NULL,TRUE,NULL,NULL,12),
('personal','¿Tiene VIH/SIDA?','booleano',NULL,TRUE,NULL,NULL,13),
('personal','¿Ha sido hospitalizado anteriormente?','booleano',NULL,TRUE,'Cuándo, por qué',NULL,14),
('personal','Otra enfermedad crónica o relevante','texto',NULL,TRUE,NULL,NULL,15),
...
-- Farmacológicos
('farmacologico','Medicamentos actuales con prescripción','lista','[{"campo":"medicamento","label":"Medicamento","requerido":true},{"campo":"dosis","label":"Dosis","requerido":false},{"campo":"frecuencia","label":"Frecuencia","requerido":false}]',TRUE,NULL,NULL,1),
...
-- Quirúrgicos
('quirurgico','Cirugías previas','lista','[{"campo":"procedimiento","label":"Procedimiento","requerido":true},{"campo":"anio","label":"Año","requerido":false}]',TRUE,NULL,NULL,1),
...
('habito','Actividad física habitual','opciones','["Sedentario","Actividad leve (caminatas)","Actividad moderada","Deportista regular"]',TRUE,NULL,NULL,4),
...
('gineco','Edad de primera menstruación (menarquia)','numero',NULL,TRUE,NULL,'FX',1),
('gineco','Ciclo menstrual','opciones','["Regular","Irregular","Sin ciclo (menopausia o anticonceptivo)"]',TRUE,NULL,'FX',2),
('gineco','¿Está en menopausia?','booleano',NULL,TRUE,'Desde cuándo','FX',3),
('gineco','Gestas (número de embarazos)','numero',NULL,TRUE,NULL,'FX',4),
('gineco','Partos vaginales','numero',NULL,TRUE,NULL,'FX',5),
('gineco','Cesáreas','numero',NULL,TRUE,NULL,'FX',6),
('gineco','Abortos (espontáneos o inducidos)','numero',NULL,TRUE,NULL,'FX',7),
('gineco','Fecha de última menstruación (FUM)','fecha',NULL,TRUE,NULL,'FX',8),
('gineco','¿Usa método de planificación familiar?','booleano',NULL,TRUE,'Cuál','FX',9),
('gineco','¿Cuándo fue su última citología (Papanicolaou)?','fecha',NULL,TRUE,NULL,'FX',10),
('gineco','¿Se realiza autoexamen de seno regularmente?','booleano',NULL,TRUE,NULL,'FX',11),
...
INSERT INTO campo_clinico (seccion, nombre, tipo, unidad, clave, orden, opciones) VALUES
  ('signos_vitales', 'Tensión arterial sistólica',  'numero', 'mmHg',  'ta_sistolica',            1,  NULL),
  ('signos_vitales', 'Tensión arterial diastólica', 'numero', 'mmHg',  'ta_diastolica',           2,  NULL),
  ('signos_vitales', 'Frecuencia cardíaca',         'numero', 'lpm',   'frecuencia_cardiaca',     3,  NULL),
  ('signos_vitales', 'Frecuencia respiratoria',     'numero', 'rpm',   'frecuencia_respiratoria', 4,  NULL),
  ('signos_vitales', 'Temperatura',                 'numero', '°C',    'temperatura',             5,  NULL),
  ('signos_vitales', 'Saturación O₂',               'numero', '%',     'saturacion_o2',           6,  NULL),
  ('signos_vitales', 'Peso',                        'numero', 'kg',    'peso',                    7,  NULL),
  ('signos_vitales', 'Talla',                       'numero', 'cm',    'talla',                   8,  NULL),
  ('signos_vitales', 'Glucometría',                 'numero', 'mg/dL', 'glucometria',             9,  NULL),
  ('signos_vitales', 'Perímetro abdominal',         'numero', 'cm',    'perimetro_abdominal',    10,  NULL),
  ('examen_fisico',  'Aspecto general',   'texto',   NULL, 'aspecto_general',     1, NULL),
  ('examen_fisico',  'Piel y mucosas',    'opciones', NULL, 'piel',                2, '["Normal","Anormal","No se explora"]'),
  ('examen_fisico',  'Cabeza y cuello',   'opciones', NULL, 'cabeza_cuello',       3, '["Normal","Anormal","No se explora"]'),
  ('examen_fisico',  'Ojos',              'opciones', NULL, 'ojos',                4, '["Normal","Anormal","No se explora"]'),
  ('examen_fisico',  'Oídos, nariz, garganta', 'opciones', NULL, 'oing',           5, '["Normal","Anormal","No se explora"]'),
  ('examen_fisico',  'Tórax',             'opciones', NULL, 'torax',               6, '["Normal","Anormal","No se explora"]'),
  ('examen_fisico',  'Pulmones',          'opciones', NULL, 'pulmones',            7, '["Normal","Anormal","No se explora"]'),
  ('examen_fisico',  'Cardiovascular',    'opciones', NULL, 'cardiovascular',      8, '["Normal","Anormal","No se explora"]'),
  ('examen_fisico',  'Abdomen',           'opciones', NULL, 'abdomen',             9, '["Normal","Anormal","No se explora"]'),
  ('examen_fisico',  'Extremidades',      'opciones', NULL, 'extremidades',       10, '["Normal","Anormal","No se explora"]'),
  ('examen_fisico',  'Neurológico',       'opciones', NULL, 'neurologico',        11, '["Normal","Anormal","No se explora"]'),
  ('examen_fisico',  'Musculoesquelético','opciones', NULL, 'musculoesqueletico', 12, '["Normal","Anormal","No se explora"]'),
  ('examen_fisico',  'Genitourinario',    'opciones', NULL, 'genitourinario',     13, '["Normal","Anormal","No se explora"]'),
  -- Revisión por sistemas (15 preguntas estándar)
  ('revision_sistemas', 'Fiebre o escalofríos',               'opciones', NULL, 'rs_fiebre',          1, '["Normal","Anormal","No sabe","No aplica"]'),
  ('revision_sistemas', 'Cefalea',                            'opciones', NULL, 'rs_cefalea',          2, '["Normal","Anormal","No sabe","No aplica"]'),
  ('revision_sistemas', 'Mareo o vértigo',                    'opciones', NULL, 'rs_mareo',            3, '["Normal","Anormal","No sabe","No aplica"]'),
  ('revision_sistemas', 'Alteraciones visuales',              'opciones', NULL, 'rs_vision',           4, '["Normal","Anormal","No sabe","No aplica"]'),
  ('revision_sistemas', 'Tos',                                'opciones', NULL, 'rs_tos',              5, '["Normal","Anormal","No sabe","No aplica"]'),
  ('revision_sistemas', 'Dificultad respiratoria',            'opciones', NULL, 'rs_disnea',           6, '["Normal","Anormal","No sabe","No aplica"]'),
  ('revision_sistemas', 'Dolor torácico o palpitaciones',     'opciones', NULL, 'rs_dolor_toracico',   7, '["Normal","Anormal","No sabe","No aplica"]'),
  ('revision_sistemas', 'Náuseas o vómito',                   'opciones', NULL, 'rs_nauseas',          8, '["Normal","Anormal","No sabe","No aplica"]'),
  ('revision_sistemas', 'Dolor abdominal',                    'opciones', NULL, 'rs_dolor_abdominal',  9, '["Normal","Anormal","No sabe","No aplica"]'),
  ('revision_sistemas', 'Diarrea o estreñimiento',            'opciones', NULL, 'rs_diarrea',         10, '["Normal","Anormal","No sabe","No aplica"]'),
  ('revision_sistemas', 'Cambios en orina (disuria/poliuria)','opciones', NULL, 'rs_orina',           11, '["Normal","Anormal","No sabe","No aplica"]'),
  ('revision_sistemas', 'Dolor articular o muscular',         'opciones', NULL, 'rs_articular',       12, '["Normal","Anormal","No sabe","No aplica"]'),
  ('revision_sistemas', 'Edema en extremidades',              'opciones', NULL, 'rs_edema',           13, '["Normal","Anormal","No sabe","No aplica"]'),
  ('revision_sistemas', 'Cambios en piel o mucosas',          'opciones', NULL, 'rs_piel_rs',         14, '["Normal","Anormal","No sabe","No aplica"]'),
  ('revision_sistemas', 'Alteraciones del sueño o ánimo',    'opciones', NULL, 'rs_suenio',          15, '["Normal","Anormal","No sabe","No aplica"]')
ON CONFLICT DO NOTHING;
...
-- Facturas de farmacia vinculadas a paciente por numero_documento
...
-- Ítems de las facturas. Los datos del medicamento se capturan al facturar
...
-- Contador anual de facturas (FAR-2026-00001, FAR-2027-00001, …)
-- Una fila por año; el contador se incrementa atómicamente al crear la factura.
CREATE TABLE IF NOT EXISTS farmacia.contador_factura (
    year   INT PRIMARY KEY,
    ultimo INT NOT NULL DEFAULT 0
);

-- Tarifas de referencia por medicamento (precio de venta en farmacia)
