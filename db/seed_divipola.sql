-- ============================================================
-- SEED DIVIPOLA — División Político-Administrativa de Colombia
-- Fuente oficial: DANE / datos.gov.co (actualización 30-dic-2024)
-- URL: https://www.datos.gov.co/resource/gdxc-w37w.json
-- Referencia cruzada: https://geoportal.dane.gov.co/descargas/divipola/
-- ============================================================
...
-- ------------------------------------------------------------
-- 1. Departamentos (33 entidades territoriales)
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- 2. Municipios (1122 municipios + distritos)
-- ------------------------------------------------------------
...
-- ARCHIPIÉLAGO DE SAN ANDRÉS, PROVIDENCIA Y SANTA CATALINA (2 municipios)
('88001','San Andrés','88'),
...
-- GUAINÍA (8 municipios/corregimientos)
('94001','Inírida','94'),
...
-- VAUPÉS (6 municipios/corregimientos)
('97001','Mitú','97'),
('97161','Carurú','97'),
('97511','Pacoa','97'),
('97666','Taraira','97'),
